...
print "For the siphon regen cycle"
pp('eta_turbine',"")
pp('eta_thermal',"")
...
Q_out = -(m_dot*(state[4]['H']-state[3]['H'])/3600)/(1000*1000)
pp('Q_out',"MW")
...
#condensor transfer
Q_out = m_dot*(state_4['H']-state_5['H'])/(3600*1000*1000)

print ""
print "For the combustor regen cycle from example 8.4"
pp('eta_turbine',"")
pp('eta_thermal',"")
